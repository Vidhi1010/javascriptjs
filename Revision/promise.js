...
const promiseOne = new Promise(function (resolve, reject) {
  setTimeout(function () {
    ...
    resolve();//use for consuming the promise
  }, 1000);
});
...
//async and await are modern JavaScript features that simplify working with asynchronous code, making it look more like synchronous code while maintaining non-blocking behavior.